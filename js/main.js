...
const createUser = (user) => {
    ...
    <div class="card">
        ...
        <div class="user-info">
            ...
            <ul class="info followers">
            <li>
                <strong>Following:<br/>${user.following}</strong>
            </li>
            <li>
            <strong>Followers:<br/>${user.followers}</strong>
            </li>
            <li>
            <strong>Repository: <br/> ${user.public_repos}</strong>
            </li>
        </ul>
        <ul class="user-links">
            <li>
        ...
        <a class="blog" href="${user.blog}" target="_blank ">${user.blog}
            </a>
            </li>
            <li>
            <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg" class="user-link-icon">
